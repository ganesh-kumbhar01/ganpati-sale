                ...
                >
                  <div className="flex justify-between items-start">
                    ...
                    <div className="text-right">
                      <p className="text-xs font-semibold text-rose-600 dark:text-rose-400">Pending: Rs. {booking.balanceAmount}</p>
                    </div>
                  </div>
          ...
          <div className="bg-white dark:bg-slate-800 shadow-sm border border-slate-200 dark:border-slate-700 rounded-2xl p-6">
            ...
            <div className="mt-8 bg-slate-50 dark:bg-slate-900/50 rounded-xl p-4 border border-slate-100 dark:border-slate-700">
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-sm font-medium text-slate-900 dark:text-white">Rs. {selectedBooking.totalPrice}</span>
              </div>
              <div className="flex justify-between items-center mb-2">
                <span className="text-sm text-slate-500">Advance Paid:</span>
                <span className="text-sm font-medium text-emerald-600 dark:text-emerald-400">Rs. {selectedBooking.advanceAmount}</span>
              </div>
              <div className="flex justify-between items-center pt-2 border-t border-slate-200 dark:border-slate-700">
                <span className="text-base font-bold text-slate-900 dark:text-white">Balance Pending:</span>
                <span className="text-xl font-bold text-rose-600 dark:text-rose-400">Rs. {selectedBooking.balanceAmount}</span>
              </div>
            </div>

            {selectedBooking.balanceAmount > 0 && (
              <div className="mt-8">
                <label className="block text-sm font-medium text-slate-700 dark:text-slate-300">Collect Final Payment (Rs. )</label>
