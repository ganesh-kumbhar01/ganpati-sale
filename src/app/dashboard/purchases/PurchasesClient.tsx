          ...
          <tbody className="bg-white dark:bg-slate-800 divide-y divide-slate-200 dark:divide-slate-700">
            {initialPurchases.map((purchase) => (
              <tr key={purchase.id} className="hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-500 dark:text-slate-400">
                  Rs. {purchase.transportCost}
                </td>
                <td className="px-6 py-4 whitespace-nowrap text-sm font-bold text-slate-900 dark:text-white">
                  Rs. {purchase.totalAmount + purchase.transportCost + purchase.otherExpenses}
                </td>
              </tr>
            ))}
                  ...
                  <div className="px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                    ...
                    {suppliers.length === 0 ? (
                      ...
                      <div className="mt-4 grid grid-cols-1 gap-y-4 gap-x-4 sm:grid-cols-2">
                        ...
                        <div className="sm:col-span-2">
                          <label className="block text-sm font-medium text-slate-700 dark:text-slate-300">Murtis Cost (Rs. )</label>
                        ...
                        <div>
                          <label className="block text-sm font-medium text-slate-700 dark:text-slate-300">Transport Cost (Rs. )</label>
                        ...
                        <div>
                          <label className="block text-sm font-medium text-slate-700 dark:text-slate-300">Other Expenses (Rs. )</label>
