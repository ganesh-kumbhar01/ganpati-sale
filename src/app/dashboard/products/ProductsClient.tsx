                ...
                <form onSubmit={handleSubmit}>
                  <div className="px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                    ...
                    <div className="grid grid-cols-1 gap-y-4 gap-x-4 sm:grid-cols-2">
                      ...
                      <div>
                        <label className="block text-sm font-medium text-slate-700 dark:text-slate-300">Purchase Price (Rs. )</label>
                      ...
                      <div>
                        <label className="block text-sm font-medium text-slate-700 dark:text-slate-300">Selling Price (Rs. )</label>
